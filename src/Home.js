    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className={`py-10 text-center transition-opacity duration-700 ${visible ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="max-w-3xl mx-auto border p-6 rounded-lg bg-gray-100 shadow-lg transition-shadow duration-300 hover:shadow-xl">
          <textarea rows="4" className="w-full p-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300" placeholder="Write your code here..."></textarea>
          <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition duration-300 transform hover:scale-105">Get Hints</button>
        </div>
      </section>
